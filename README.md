...
2. Share your GitHub account's email ID (or account name) with one of the admins, so we can send you an invite to join the organization. You can share it in our FLL WhatsApp group. 
